...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.clusterProb_RadioBtn = QtGui.QRadioButton(self.centralwidget)
        self.clusterProb_RadioBtn.setEnabled(False)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.clusterProb_RadioBtn.sizePolicy().hasHeightForWidth())
        self.clusterProb_RadioBtn.setSizePolicy(sizePolicy)
